...
LABEL_SETS = {
    ...
    "Toygar/turkish-offensive-language-detection": {
        ...
        "description": {
            0: ["Bu metin saldırgan dil, hakaret, nefret söylemi, küfür veya agresif içerik barındırmaktadır."],
            1: ["Bu metin saldırgan dil içermemekte ve saygılı, tarafsız veya kibar bir şekilde yazılmıştır."],
        },
    },
}
