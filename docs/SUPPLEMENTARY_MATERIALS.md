...
Full Macro-F1 scores (%) for all 7 models x 9 datasets:

| Model | AG News | Banking77 | DBpedia-14 | GoEmotions | 20 Newsgroups | Twitter Fin. | Yahoo Ans. | IMDB | SST-2 | Average |
|-------|---------|-----------|------------|------------|---------------|--------------|------------|------|-------|---------|
| INSTRUCTOR-large | 85.1 | 61.7 | 81.9 | 20.4 | 60.4 | 64.1 | 54.4 | — | — | — |
| Qwen3-Embedding | 78.2 | 74.4 | 83.6 | 21.0 | 59.4 | 64.6 | 49.3 | — | — | — |
| all-mpnet-base-v2 | 81.4 | 62.4 | 77.8 | 14.8 | 56.8 | 56.8 | 49.3 | — | — | — |
| jina-embeddings-v3 | 79.9 | 70.7 | 76.5 | 22.4 | 57.2 | 43.4 | 48.5 | — | — | — |
| multilingual-e5-large | 84.3 | 59.0 | 81.2 | 17.4 | 50.5 | 49.7 | 47.4 | — | — | — |
| bge-m3 | 77.9 | 67.1 | 75.6 | 20.2 | 51.5 | 40.8 | 45.6 | — | — | — |
| nomic-embed-text-v1.5 | — | — | — | — | — | — | — | — | — | — |

*Note: IMDB and SST-2 results pending full experiment run. Averages will be updated after re-execution.*
...
| IMDB | `stanfordnlp/imdb` | 2 | Movie sentiment | test | 1,000 |
| SST-2 | `stanfordnlp/sst2` | 2 | Movie sentiment | validation | 872 |
...
| IMDB | 1,325 | 0.112 | Sentiment analysis |
| SST-2 | 52 | 0.112 | Sentiment analysis |
...
- Required datasets for 80% power: 7 (current: 9)
- Required datasets for 90% power: 9 (current: 9) — satisfied

The current benchmark with 9 datasets provides adequate statistical power to detect the observed moderate effect size. The significant Friedman test result is reliable and not attributable to insufficient power.
...
All 63 canonical experiment configurations are in `experiments/`. Each YAML file specifies
...
| All configs in repository | Yes (63 canonical + label formulation configs) |
