"""Create Jina experiment configs with task='classification' parameter for all 6 datasets."""
...
for ds_name, text_col, label_col, split, max_samples in datasets:
    ...
    exp_name = f"{exp_name}_jina_task"
...
print(f"\n📊 Created {len(datasets)} Jina configs with task='classification'!")